...
renderView1.CenterOfRotation = [1.0, 0.0, 1.34999996423721]
renderView1.StereoType = 0
renderView1.CameraPosition = [-1.62847824172301, -3.2027860136308, 2.40844821866375]
renderView1.CameraFocalPoint = [1.0, 0.0, 1.34999996423721]
renderView1.CameraViewUp = [0.15348939439032996, 0.19422464830378394, 0.9688744974458566]
renderView1.CameraParallelScale = 1.10679717701994
...
clip1Display.DiffuseColor = [0.0, 0.666666666666667, 1.0]
...
clip1Display.ScalarOpacityUnitDistance = 0.0432153174508455
clip1Display.GaussianRadius = 0.5
...
for t in DT:
    ...
    timeKeeper1.Time=t
    Render(renderView1)
    SaveScreenshot('frameBackCut_'+str(t)+'.png', renderView1, ImageResolution=[3388, 1777])
#
