...
renderView1.CenterOfRotation = [1.0, 0.0, 0.8999999761581421]
renderView1.StereoType = 0
renderView1.CameraPosition = [-2.2148323535081618, -3.9172552142696317, 2.194564123135481]
renderView1.CameraFocalPoint = [1.0, 0.0, 0.8999999761581421]
renderView1.CameraViewUp = [0.15348939439032996, 0.19422464830378394, 0.9688744974458566]
renderView1.CameraParallelScale = 1.3536986218774087
...
#outline1 = Outline()
#outline1.Bounds = [0.0, 20.0, -0.15, 0.15, 0.0, 0.9]
from paraview import simple
creator = simple._create_func("Outline", simple.servermanager.sources)
outline1 = creator(guiName="outline1", Bounds=[0.0, 20.0, -0.15, 0.15, 0.0, 0.9])
...
isoVolume1Display.DiffuseColor = [0.0, 0.666666666666667, 1.0]
isoVolume1Display.Scale = [0.1, 1.0, 2.0]
isoVolume1Display.OSPRayScaleArray = 'nodeMaterialTypes'
isoVolume1Display.OSPRayScaleFunction = 'PiecewiseFunction'
isoVolume1Display.SelectOrientationVectors = 'None'
isoVolume1Display.ScaleFactor = 2.0
isoVolume1Display.SelectScaleArray = 'nodeMaterialTypes'
isoVolume1Display.GlyphType = 'Arrow'
isoVolume1Display.GlyphTableIndexArray = 'nodeMaterialTypes'
isoVolume1Display.DataAxesGrid = 'GridAxesRepresentation'
isoVolume1Display.PolarAxes = 'PolarAxesRepresentation'
isoVolume1Display.ScalarOpacityUnitDistance = 0.0676048405133472
isoVolume1Display.GaussianRadius = 1.0
isoVolume1Display.SetScaleArray = ['POINTS', 'nodeMaterialTypes']
isoVolume1Display.ScaleTransferFunction = 'PiecewiseFunction'
isoVolume1Display.OpacityArray = ['POINTS', 'nodeMaterialTypes']
isoVolume1Display.OpacityTransferFunction = 'PiecewiseFunction'

# init the 'PolarAxesRepresentation' selected for 'PolarAxes'
isoVolume1Display.PolarAxes.Scale = [0.1, 1.0, 2.0]
...
for t in DT:
    ...
    timeKeeper1.Time=t
    Render(renderView1)
    SaveScreenshot('frameBack_'+str(t)+'.png', renderView1, ImageResolution=[3388, 1777])
#
