...
renderView1.CameraPosition = [5.148932477520468, -3.0204918941993895, 1.9094155593429205]
...
for t in DT:
    ...
    timeKeeper1.Time=t
    Render(renderView1)
    SaveScreenshot('frameFront_'+str(t)+'.png', renderView1, ImageResolution=[3388, 1777])
#
